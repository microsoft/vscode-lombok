...
import { initializeFromJsonFile, dispose as disposeTelemetryWrapper, instrumentOperation, instrumentOperationAsVsCodeCommand, sendInfo } from 'vscode-extension-telemetry-wrapper';
